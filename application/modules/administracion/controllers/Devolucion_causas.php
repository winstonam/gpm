 ...
 * Time: 01:14 AM
 */
class Devolucion_causas extends Admin_Controller
{
    ...
    {
        $data['js_data'] = array(
            base_url() . 'assets/custom/causas_devolucion.js',
            //  base_url().'assets/plugins/select2/select2.full.min.js',
        );

        $data['page'] = $this->config->item('gpm_sys_web_template_dir_admin') . "devolucion_causas_lista";
        $data['modals'] = array(
            $this->load->view($this->config->item('gpm_sys_web_template_dir_admin') . "devolucion_causas_registrar", '', TRUE),
        );
