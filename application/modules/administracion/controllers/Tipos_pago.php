 ...
 * Time: 01:14 AM
 */
class Tipos_pago extends Admin_Controller
{
    ...
    {
        $data['js_data'] = array(
            base_url() . 'assets/custom/tipos_pago.js',
            //  base_url().'assets/plugins/select2/select2.full.min.js',
        );

        $data['page'] = $this->config->item('gpm_sys_web_template_dir_admin') . "tipos_pago_lista";
        $data['modals'] = array(
            $this->load->view($this->config->item('gpm_sys_web_template_dir_admin') . "tipos_pago_registrar", '', TRUE),
        );
