var url_nuevo = base_url + 'administracion/tipos_pago/guardar_tipo_pago';
var url_editar = base_url + 'administracion/tipos_pago/actualizar_tipo_pago';
$(document).ready(function () {
    ...
    var tabla_tipos_pago = $('#tabla_tipos_pago').DataTable({
        ...
        "scrollX": true,
        ajax: {
            "url": base_url + "administracion/tipos_pago/obtener_tipos_pagos/",
            "type": 'POST',
            "dataSrc": ""
        },
        "columns": [
