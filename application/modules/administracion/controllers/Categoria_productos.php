 ...
 * Time: 01:14 AM
 */
class Categoria_productos extends Admin_Controller
{
    ...
    {
        $data['js_data'] = array(
            base_url() . 'assets/custom/categorias_producto.js',
            //  base_url().'assets/plugins/select2/select2.full.min.js',
        );

        $data['page'] = $this->config->item('gpm_sys_web_template_dir_admin') . "categorias_producto_lista";
        $data['modals'] = array(
            $this->load->view($this->config->item('gpm_sys_web_template_dir_admin') . "categorias_producto_registrar", '', TRUE),
        );
