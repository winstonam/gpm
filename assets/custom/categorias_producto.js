var url_nuevo = base_url + 'administracion/categoria_productos/guardar';
var url_editar = base_url + 'administracion/categoria_productos/actualizar';
$(document).ready(function () {
    ...
    var tabla_cat_prods = $('#tabla_cat_prods').DataTable({
        ...
        "scrollX": true,
        ajax: {
            "url": base_url + "administracion/categoria_productos/obtener/",
            "type": 'POST',
            "dataSrc": ""
        },
        "columns": [
