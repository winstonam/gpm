            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <a href="" class="logo">
                        ...
                        <span class="logo-lg"><img class="img-responsive" src="<?php echo base_url().('assets/imgs/logo-gpm.jpg') ?>"></span>
                    </a>
                    ...
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <form role="form" method="POST" action="<?php echo base_url('acceso/acceso_admin/autenticar_admin') ?>">
                            <fieldset>
                               ...
                               <!-- Change this to a button or input when using this as a form -->
                                <button class="btn btn-lg btn-success btn-block" type="submit">Iniciar sesi&oacute;n Admin</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
