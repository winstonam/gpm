var url_nuevo = base_url + 'ventas/devolucion_causas/guardar';
var url_editar = base_url + 'ventas/devolucion_causas/actualizar';
$(document).ready(function () {
    ...
    var tabla_dc = $('#tabla_dc').DataTable({
        ...
        "scrollX": true,
        ajax: {
            "url": base_url + "ventas/devolucion_causas/obtener/",
            "type": 'POST',
            "dataSrc": ""
        },
        "columns": [
