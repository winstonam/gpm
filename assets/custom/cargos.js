var url_nuevo = base_url + 'administracion/cargos/guardar_cargo';
var url_editar = base_url + 'administracion/cargos/actualizar_cargo';
$(document).ready(function () {
    ...
    var tabla_cargos = $('#tabla_cargos').DataTable({
        ...
        "scrollX": true,
        ajax: {
            "url": base_url + "administracion/cargos/obtener_cargos/",
            "type": 'POST',
            "dataSrc": ""
        },
        "columns": [
